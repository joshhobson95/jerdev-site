const cactusdata =
{
    ...
    },
    {
        ...
        description: "Teddy bear cholla is a striking, drought-tolerant cactus native to the deserts of New Mexico. Known for its dense, spiny cylindrical stems that can easily detach, it can be dangerous to handle, earning its 'teddy bear' nickname due to its appearance. In spring, it produces vibrant yellow-green flowers, followed by reddish fruits that attract birds and other wildlife. This cactus thrives in full sun and well-draining, rocky soils, requiring minimal water once established. Teddy bear cholla is ideal for xeriscaping and desert gardens, adding a bold, unique element to low-water landscapes..",
        sunIcon: "https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/plant_card_icons/FullSun.png",
        sunRequirement: "Full Sun",
        waterIcon: "https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/plant_card_icons/Low-water.png",
        waterRequirement: "Low Water",
