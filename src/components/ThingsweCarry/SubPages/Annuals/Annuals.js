  ...
  return (
    <div className='Annuals'>
        ...
        <div className='annuals_body_top_text'>
          ...
          <p>Annual plants complete their entire life cycle—from germination to seed production—within a single growing season, which usually lasts a few months to one year. After producing seeds, these plants die. Interestingly, only about 6% of all plant species are annuals, and many of these are herbs and vegetables. For instance, pea plants produce seeds (pea pods) and typically die in the fall. Similarly, plants like Cosmos and other wildflowers bloom beautifully, disperse their seeds, and perish as colder months set in. These are considered true annuals. </p>

        </div>

          <div className='plant_examples'>
          <h3>Jericho's Top 10 Annuals</h3>
          ...
          <div className='plant_examples_inner'>
            ...
            <div className='annuals_body_bottom_text'>
              <h2>Keep in mind</h2>
              <p>
              <p>Some plants, although often treated as annuals, are actually perennials in their native climates. For example, Snapdragons in Albuquerque, due to the colder winters, may not survive beyond a single season. However, in warmer climates like California, Snapdragons can thrive as perennials, returning year after year.</p>
              </p>
            </div>
