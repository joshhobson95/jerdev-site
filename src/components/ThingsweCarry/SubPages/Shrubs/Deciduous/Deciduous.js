...
function Deciduous() {
  ...
  return (
    ...
    <div className='deciduous_shrub_container'>
      <div className='deciduous_top_text'> 
      ...
      <div className='deciduous_examples'>      


            <div className='deciduous_example_each' onClick={toggleBoxwoodVisibility} style={{ cursor: 'pointer' }}>
                <h2>Boxwood</h2>
                <img className='deciduous_example_image' src='https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/Shrubs/deciduous/boxwood.jpg'alt='Boxwood Shrub at Jericho Nursery in Albuquerque, New Mexico'/>
                <div className={`deciduous_exerb ${isBoxwoodVisible ? 'visible2' : 'hidden2'}`}>
              ...
              <div className='deciduous_example_each' onClick={toggleBoxwoodVisibility} style={{ cursor: 'pointer' }}>
                <h2>Photinia</h2>
                <img className='deciduous_example_image' src='https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/Shrubs/deciduousShrub.jpg'alt='Boxwood Shrub at Jericho Nursery in Albuquerque, New Mexico'/>
                <div className={`deciduous_exerb ${isBoxwoodVisible ? 'visible2' : 'hidden2'}`}>
                    <h3>Black Knight (Purple)</h3>
                    <p>Quisque vulputate, eros a finibus commodo, felis libero interdum risus, vel efficitur lacus ex id elit. Praesent vel tincidunt elit, in sagittis eros. Curabitur vel dapibus magna, ut elementum ex. Aenean nec augue sit amet arcu bibendum accumsan. Nullam commodo tortor nec tortor rutrum, nec placerat enim tristique. Morbi vitae leo ac arcu tempus volutpat non vel ipsum. Ut vehicula velit quis velit congue, id elementum massa viverra.</p>
                    <h3>Miss Molly (Pink)</h3>
              ...
              <div className='deciduous_example_each' onClick={toggleBoxwoodVisibility} style={{ cursor: 'pointer' }}>
                <h2>Holly</h2>
                <img className='deciduous_example_image' src='https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/Shrubs/deciduous/holly.jpg'alt='Boxwood Shrub at Jericho Nursery in Albuquerque, New Mexico'/>
                <div className={`deciduous_exerb ${isBoxwoodVisible ? 'visible2' : 'hidden2'}`}>
                    <h3>Black Knight (Purple)</h3>
                    <p>Quisque vulputate, eros a finibus commodo, felis libero interdum risus, vel efficitur lacus ex id elit. Praesent vel tincidunt elit, in sagittis eros. Curabitur vel dapibus magna, ut elementum ex. Aenean nec augue sit amet arcu bibendum accumsan. Nullam commodo tortor nec tortor rutrum, nec placerat enim tristique. Morbi vitae leo ac arcu tempus volutpat non vel ipsum. Ut vehicula velit quis velit congue, id elementum massa viverra.</p>
                    <h3>Miss Molly (Pink)</h3>
              ...
              <div className='deciduous_example_each' onClick={toggleBoxwoodVisibility} style={{ cursor: 'pointer' }}>
                <h2>Nandina</h2>
                <img className='deciduous_example_image' src='https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/Shrubs/deciduous/nandina.jpg'alt='Boxwood Shrub at Jericho Nursery in Albuquerque, New Mexico'/>
                <div className={`deciduous_exerb ${isBoxwoodVisible ? 'visible2' : 'hidden2'}`}>
                    <h3>Black Knight (Purple)</h3>
                    <p>Quisque vulputate, eros a finibus commodo, felis libero interdum risus, vel efficitur lacus ex id elit. Praesent vel tincidunt elit, in sagittis eros. Curabitur vel dapibus magna, ut elementum ex. Aenean nec augue sit amet arcu bibendum accumsan. Nullam commodo tortor nec tortor rutrum, nec placerat enim tristique. Morbi vitae leo ac arcu tempus volutpat non vel ipsum. Ut vehicula velit quis velit congue, id elementum massa viverra.</p>
                    <h3>Miss Molly (Pink)</h3>
              ...
              <div className='deciduous_example_each' onClick={toggleBoxwoodVisibility} style={{ cursor: 'pointer' }}>
                ...
                <img className='deciduous_example_image' src='https://jericho-content.nyc3.cdn.digitaloceanspaces.com/VARIOUS/SEO_photos/Shrubs/deciduous/cotoneaster.jpg'alt='Boxwood Shrub at Jericho Nursery in Albuquerque, New Mexico'/>
                <div className={`deciduous_exerb ${isBoxwoodVisible ? 'visible2' : 'hidden2'}`}>
                    <h3>Black Knight (Purple)</h3>
                    <p>Quisque vulputate, eros a finibus commodo, felis libero interdum risus, vel efficitur lacus ex id elit. Praesent vel tincidunt elit, in sagittis eros. Curabitur vel dapibus magna, ut elementum ex. Aenean nec augue sit amet arcu bibendum accumsan. Nullam commodo tortor nec tortor rutrum, nec placerat enim tristique. Morbi vitae leo ac arcu tempus volutpat non vel ipsum. Ut vehicula velit quis velit congue, id elementum massa viverra.</p>
                    <h3>Miss Molly (Pink)</h3>
