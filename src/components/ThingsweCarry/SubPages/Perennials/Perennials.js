...
<div className='perennials_body_top_text'>
  ...
  <p>Perennial plants are those that live for more than two years, often blooming and producing seeds multiple times throughout their lifespan. Unlike annuals, perennials do not die after a single growing season. Instead, they go dormant during colder months and regrow when conditions are favorable again. Common examples of perennials include lavender, peonies, and hostas. These plants may take a few years to reach full maturity but can provide beautiful blooms and foliage year after year with proper care. Some perennials, like certain types of roses, require minimal maintenance and can thrive in various climates, making them a popular choice for gardeners. </p>

</div>

  <div className='plant_examples'>
  <h3>Jericho's Top 10 Perennials</h3>
  ...
  <div className='plant_examples_inner'>
    ...
    <div className='perennials_body_bottom_text'>
      ...
      <p>
      <p>Some perennials have astonishingly long lifespans. For example, peonies can live for over 50 years, often blooming more beautifully as they age. Certain trees, like the Bristlecone Pine, can live for thousands of years, with some specimens exceeding 4,000 years in age. Perennials like these showcase the incredible longevity that plants can achieve, often outliving multiple generations of humans while continuing to thrive and adapt to their environments.</p>
      </p>
    </div>
